...
class Movement(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameters(namespace='', parameters=[
            ('kp_azm',0.16), ('ki_azm',0.01), ('kd_azm',0.075),
            ('kp_alt',0.1), ('ki_alt',0.02), ('kd_alt',0.075)
            ])
        ...
        self.servo1 = servo.Servo(pca.channels[0], min_pulse=500, max_pulse=2500)
        self.servo2 = servo.Servo(pca.channels[1], min_pulse=500, max_pulse=2500)
        self.servo1.angle = 90
        self.servo2.angle = 90

        self.subscription = self.create_subscription(Float64MultiArray, '/view/bbox_info', self.bbox_to_center, 10)
    ...
    def calc_arc_change(self):
        ...
        self.get_logger().info(f"ChangeX: {change_x} | ChangeY: {change_y} ")
    ...
    def update_servo(self, control_azm, control_alt):
        ...
        self.servo1.angle = self.control_angle_azm
        self.servo2.angle = self.control_angle_alt
